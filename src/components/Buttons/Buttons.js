...
const Cancel = ({ className, ...props }) => {
	...
	//
	return <Button icon={icons.cancel} label='Cancel' {...props} className={className} />
}

const Reset = ({ className, ...props }) => {
	className = merge`${className} reset`
	//
	return <Button icon={icons.reset} label='Reset' {...props} className={className} />
}
...
const Submit = ({ className, ...props }) => {
	...
	return <Button icon={icons.submit} label='Submit' {...props} className={className} />
}

const Save = ({ className, ...props }) => {
	className = merge`${className} save`
	return <Button icon={icons.save} label='Save' {...props} className={className} />
}

const Create = ({ className, ...props }) => {
	className = merge`${className} create`
	return <Button icon={icons.create} label='Create' {...props} className={className} />
}

const Edit = ({ className, ...props }) => {
	className = merge`${className} edit`
	return <Button icon={icons.edit} label='Edit' {...props} className={className} />
}

const Delete = ({ className, ...props }) => {
	className = merge`${className} delete`
	return <Button icon={icons.delete} label='Delete' {...props} className={className} />
}
