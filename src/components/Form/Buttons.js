...
const Cancel = ( { disabled, onClick, ...props } ) => {
    ...
    return (
        <ButtonsBase.Cancel onClick={handler} disabled={disabled} {...props} />
    );
}
...
const Reset = ( { disabled, onClick, ...props } ) => {
    ...
    return (
        <ButtonsBase.Reset onClick={handler} disabled={disabled} {...props} />
    );
}
...
const FullReset = ( { disabled, onClick, ...props } ) => {
    ...
    disabled = disabled || isProcessing;
    return (
        <ButtonsBase.FullReset onClick={handler} disabled={disabled} {...props} />
    );
}
