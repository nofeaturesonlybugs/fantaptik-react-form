...
const useForm = ( {
    ...
    const [state, setState] = React.useState( {
        data : __data, snapshotData : __data, originalData : __data,
        result : null, validation : validator( __data ),
        isDirty : false, isProcessing : false,
    } );
    console.log("useForm","state",state);//TODO RM
    //
...
export const useFormDefaultResult = {
    data : null, setData : data => null, updateData : data => null,
    originalData : null, snapshotData : null,
    result : null, validation : null,

    isDirty : false, isProcessing : false,

    cancel : () => null,
    fullReset : () => null, reset : () => null,
    submit : () => null,
}
